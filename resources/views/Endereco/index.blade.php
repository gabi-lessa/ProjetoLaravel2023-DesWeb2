...
@section('content')
    <div class="container">
        ...
        <div class="py-2 float-end">
            <a href="{{ route('endereco.create') }}" class="btn btn-outline-success">Criar Endereço <i
                    class="fa-regular fa-plus"></i></a>
            <a href="{{ route('home') }}" class="btn btn-outline-secondary">Voltar <i
        ...
        <table class="table text-center table-hover" id="table">
            <thead>
                <tr>
                    ...
                    <th scope="col" width="15%">Bairro</th>
                    <th scope="col" width="25%">Logradouro</th>
            ...
            <tbody>
                ...
                @foreach ($enderecos as $endereco)
                    <tr>
                        <td class="text-center">{{ $endereco->id }}</td>
                        ...
                        <td><a class="link link-primary" href="{{ route('endereco.show', $endereco->id) }}"><i
                                    class="fa-solid fa-magnifying-glass fa-lg"></i></a></td>
                        <td><a class="link link-info" href="{{ route('endereco.edit', $endereco->id) }}"><i
                        ...
                        <td><a class="link link-danger btnRemover" href="#" data-bs-toggle="modal"
                                ...
                                value="{{ route('endereco.destroy', $endereco->id) }}"><i

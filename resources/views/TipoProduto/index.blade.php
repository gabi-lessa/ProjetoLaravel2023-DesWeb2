...
@section('content')
    <div class="container">
        ...
        <div class="py-2 float-end">
            <a href="{{ route('tipoproduto.create') }}" class="btn btn-outline-success">Criar TipoProduto <i
            ...
            <tbody>
                ...
                @foreach ($tipoProdutos as $tipoProduto)
                    <tr>
                        ...
                        <td><a class="link link-primary" href="{{ route('tipoproduto.show', $tipoProduto->id) }}"><i
                                    class="fa-solid fa-magnifying-glass fa-lg"></i></a></td>
                        <td><a class="link link-info" href="{{ route('tipoproduto.edit', $tipoProduto->id) }}"><i
                        ...
                        <td><a class="link link-danger btnRemover" href="#" data-bs-toggle="modal"
                                ...
                                value="{{ route('tipoproduto.destroy', $tipoProduto->id) }}"><i
